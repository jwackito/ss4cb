class ListaEnlazada {
    ...
    public static void main(String[] args) {
        ListaEnlazada listaNumerica = new ListaEnlazada();
        listaNumerica.insertarAlFinal(10);
        listaNumerica.insertarAlFinal(20);
        listaNumerica.insertarAlFinal(30);
        listaNumerica.insertarAlFinal(40);
        System.out.print("Lista: ");
        listaNumerica.imprimirLista();
        listaNumerica.eliminarPorValor(20);
        System.out.print("Despues de eliminar 20: ");
        listaNumerica.imprimirLista();
    }
}
